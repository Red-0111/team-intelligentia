...
$.contactButtons({
  ...
  buttons : {
      'facebook': { class: 'facebook', use: true, link: 'https://www.facebook.com/DoEPWDs', extras: 'target="_blank"' },
      'twitter': { class: 'twitter', use: true, link: 'https://www.twitter.com/@socialpwds', extras: 'target="_blank"' },
